...
np.save(f"{swat_folder}/swat_mean.npy", swat_mean)
np.save(f"{swat_folder}/swat_std.npy", swat_std)
...
np.save(f"{synth_folder}/synth_mean.npy", synth_mean)
np.save(f"{synth_folder}/synth_std.npy", synth_std)
